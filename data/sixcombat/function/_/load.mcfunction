...
scoreboard objectives add sixcombat.hardening_timer dummy
scoreboard objectives add sixcombat.accelerating_stacks dummy
scoreboard objectives add sixcombat.accelerating_ticks dummy

scoreboard objectives add _sixcombat.fleeting_trigger dummy
