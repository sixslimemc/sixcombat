...
data modify storage delay:in delay set value {ticks:3, command:"function sixcombat:_/player/ench/echo_shot/fire", data:{projectile_type:1}}
...
execute if score *echo_shot.level _sixcombat matches 2.. run data modify storage delay:in delay.ticks set value 2
