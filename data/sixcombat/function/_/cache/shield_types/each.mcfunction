...
# item name:
data remove storage sixcombat:_ var.cache.shield_name
data merge storage sixcombat:_ {x:{1:"data modify storage sixcombat:_ var.cache.shield_name set from storage sixcombat:_ var.cache.shield_names.'", 2:true, 3:"'"}}
data modify storage sixcombat:_ x.2 set from storage sixcombat:_ var.cache.this_type
function six:-/mline/3 with storage sixcombat:_ x
execute if data storage sixcombat:_ var.cache.shield_name run data modify storage sixcombat:_ var.cache.entry.components."minecraft:item_name" set from storage sixcombat:_ var.cache.shield_name
