...
data modify storage sixcombat:_ var.cache.this_weapon set from storage sixcombat:_ var.cache.weapons[-1]
...
data modify storage sixcombat:_ var.cache.entry.attributes[-1].amount set from storage sixcombat:_ var.cache.this_weapon.damage
...
execute store result score *x _sixcombat run data get storage sixcombat:_ var.cache.this_weapon.attack_speed 10000
...
data modify storage sixcombat:_ var.cache.entry.attributes[-1].amount set from storage sixcombat:_ var.cache.this_weapon.knockback
execute if data storage sixcombat:_ var.cache.this_weapon{knockback:0f} run data remove storage sixcombat:_ var.cache.entry.attributes[-1]
...
data modify storage sixcombat:_ var.cache.entry.attributes[-1].amount set from storage sixcombat:_ var.cache.this_weapon.range_modifier
execute if data storage sixcombat:_ var.cache.this_weapon{range_modifier:0f} run data remove storage sixcombat:_ var.cache.entry.attributes[-1]

# disable block:
data modify storage sixcombat:_ var.cache.entry.components."minecraft:weapon".disable_blocking_for_seconds set from storage sixcombat:_ var.cache.this_weapon.disable_block_seconds

# blocks attacks:
data modify storage sixcombat:_ x.bdata set from storage sixcombat:_ var.cache.this_weapon.blocks_attacks
...
execute unless data storage sixcombat:_ var.cache.this_weapon{blocks_attacks:false} run data modify storage sixcombat:_ var.cache.entry.components."minecraft:blocks_attacks" set from storage sixcombat:_ x.bcomp

# additional attributes:
data modify storage sixcombat:_ x.attrs set from storage sixcombat:_ var.cache.this_weapon.additional_modifiers
...
data modify storage sixcombat:_ x.mline.2 set from storage sixcombat:_ var.cache.this_weapon.item
function six:-/mline/3 with storage sixcombat:_ x.mline

data remove storage sixcombat:_ var.cache.weapons[-1]
