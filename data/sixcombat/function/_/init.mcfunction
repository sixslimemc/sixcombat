...
data modify storage sixcombat:config shield.wooden.block merge value {delay_ticks:4, disable_cooldown_scale:1.4f, max_angle:70, damage_reduction:{percent:0.30}, blocking_modifiers:{persist_ticks:18}}
